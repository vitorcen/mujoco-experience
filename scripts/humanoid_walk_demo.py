...
def main():
    parser = argparse.ArgumentParser(description="Humanoid Walk MoCap Demo")
    ...
    parser.add_argument("--record", type=str, help="录制视频文件（如 walk.mp4）")
    ...
    try:
        ...
        print("\n解决方案:")
        print("  1. Headless 运行: python scripts/humanoid_walk_demo.py --headless")
        print("  2. 录制视频: MUJOCO_GL=egl python scripts/humanoid_walk_demo.py --record walk.mp4")
